...
import 'library/ztp20/ztp20Permit'

const ZTP20Inst = new ZTP20Permit();
...
function init() {
    ...
    Utils.assert(implementsInterface(ZTP20Inst, IZTP20Permit), "ZTP20 class does not implement IZTP20Permit");
