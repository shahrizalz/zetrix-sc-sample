...
const Chain = {
     ...
     */
    load(key) {
        if(INTERNAL_STORAGE[key] === undefined) {
            return false;
        }
     ...
     */
    del(key) {
        INTERNAL_STORAGE[key] = undefined;
        return true;
    },
    ...
    tlog(topic, msg1 = '', msg2 = '', msg3 = '', msg4 = '', msg5 = '') {
        console.log(topic, msg1, msg2, msg3, msg4, msg5);
        return true;
    },
    ...
    getAccountMetadata(address, key) {
        if (ACCOUNT_METADATA[address] !== null) {
            return ACCOUNT_METADATA[address][key];
        }
    },
    ...
    getAccountAsset(address, assetKey) {
        if (ACCOUNT_ASSET[address] !== null) {
            return ACCOUNT_ASSET[address][assetKey];
        }
    },
    ...
    getAccountPrivilege(address) {
        return ACCOUNT_PRIVILEGE[address];
    },
    ...
    getContractProperty(address) {
        return CONTRACT_PROPERTY[address];
    },
